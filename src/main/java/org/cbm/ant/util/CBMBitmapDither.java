...
public enum CBMBitmapDither
{
	...
	ORDERED_2("Ordered 2x2", new CBMBitmapOrderedDitherStrategy(new int[] {
			1, 3, 4, 2
	}, 5)),

	ORDERED_3("Ordered 3x3", new CBMBitmapOrderedDitherStrategy(new int[] {
			3, 7, 4, 6, 1, 9, 2, 8, 5
	}, 10)),

	ORDERED_4("Ordered 4x4", new CBMBitmapOrderedDitherStrategy(new int[] {
			1, 9, 3, 11, 13, 5, 15, 7, 4, 12, 2, 10, 16, 8, 14, 6
	}, 17)),

	ORDERED_8("Ordered 8x8", new CBMBitmapOrderedDitherStrategy(new int[] {
