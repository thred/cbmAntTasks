...
public class CBMBitmapColorComponent extends JComponent implements ActionListener
{
    ...
    private final JRadioButtonMenuItem doNotUseItem =
        CBMBitmapUtils.createRadioButtonMenuItem("Do Not Use Color", this);
    private final JRadioButtonMenuItem optionalItem = CBMBitmapUtils.createRadioButtonMenuItem("Optional Color", this);
    private final JRadioButtonMenuItem mandatoryItem =
        CBMBitmapUtils.createRadioButtonMenuItem("Mandatory Color", this);
    ...
    public void pickHue()
    {
        Picker picker = new Picker(color -> {
