...
import org.cbm.ant.util.bitmap.tool.CBMBitmapContrastAndBrightnessToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapConversionToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapDitherModeToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapEmbossToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapPaletteToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapResizeSourceImageToolAction;
import org.cbm.ant.util.bitmap.tool.CBMBitmapTargetSizeToolAction;
...
public class CBMBitmapFrame extends JFrame
{
    ...
    private final Collection<CBMBitmapProjectController> controllers = new ArrayList<>();
    ...
    public CBMBitmapFrame(GraphicsConfiguration gc)
    {
        ...
        targetMenu.add(new JCheckBoxMenuItem(CBMBitmapUtils.get(CBMBitmapConversionToolAction.class)));
        ...
        toolPanel.addTool(CBMBitmapUtils.get(CBMBitmapConversionToolAction.class));

        tabbedPane.setVisible(false);
        tabbedPane.addChangeListener(e -> {
            CBMBitmapProjectController controller = getController(tabbedPane.getSelectedComponent());

            toolPanel.onCBMBitmapProjectUpdate(controller, controller != null ? controller.getModel() : null, null);
        });
    ...
    public CBMBitmapProjectController createController()
    {
        ...
        model.addPropertyChangeListener(event -> toolPanel.onCBMBitmapProjectUpdate(controller, model, event));
